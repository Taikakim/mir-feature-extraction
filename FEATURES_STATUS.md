...
| `.ONSETS` | Onset timestamps — required for syncopation/complexity; generated by `process_folder_rhythm()` combined worker | Complete |
...
| Metadata lookup | Complete | Spotify + MusicBrainz + Tidal (via ISRC); AcoustID fingerprinting fallback |
